...
for j=1:M
    ...
    P_w_y_Spam(j)=(1+Sum)/Total_word_count_Spam;
end
...
for j=1:M
    ...
    P_w_y_Not_Spam(j)=(1+Sum)/Total_word_count_Not_Spam;
end
...
for i=1:size(Test_X,1)
    ...
    P_di_y_Spam(i)=P_di_y_Spam(i)*P_y_Spam;
end
